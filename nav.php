<?php include ("include/header.php");?>
    <!--start navbar-->
    <nav class="navbar navbar-edit navbar-expand-lg navbar-light ">
                <div class="container">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                           <button type="button" class="btn btn-outline-light"><i class="fas fa-sign-out-alt"></i>تسجيل الخروج</button>
                        </li>
                     </ul>
                    </div>
